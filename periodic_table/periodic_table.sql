...
--
-- Name: elements uniques; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.elements
    ADD CONSTRAINT uniques UNIQUE (symbol, name);


--
-- Name: properties pk; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.properties
    ADD CONSTRAINT pk FOREIGN KEY (atomic_number) REFERENCES public.elements(atomic_number);
